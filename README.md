...
- Create a separate page for each game where users can read more details about each game. It will create a separate URL for each game based on their pk and house all the other information as well as an area for users to submit their ratings.